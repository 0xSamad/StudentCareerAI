#!/usr/bin/env node
/**
 * openai-tailor.mjs — OpenAI-compatible CV Tailoring for student-career-ai
 *
...
if (args.length === 0 || args[0] === '--help' || args[0] === '-h') {
  console.log(`
╔══════════════════════════════════════════════════════════════════╗
║      student-career-ai — OpenAI-compatible CV Tailoring (Headless)      ║
╚══════════════════════════════════════════════════════════════════╝
...
// Build system prompt
// ---------------------------------------------------------------------------
const systemPrompt = `You are student-career-ai, an AI-powered CV tailoring engine.
