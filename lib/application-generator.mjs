/**
 * application-generator.mjs — Application Content Generator for CareerOS
 *
...
function buildCoverLetterSystemPrompt() {
  return `You are CareerOS, a professional cover letter writer for students.
...
function buildAnswerSystemPrompt() {
  return `You are CareerOS answering a job application form question on behalf of a student.
