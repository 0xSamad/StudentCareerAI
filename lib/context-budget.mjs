/**
 * context-budget.mjs — Token budget management for student-career-ai evaluators
 *
...
/**
 * Default maximum prompt tokens (conservative budget; gpt-5.6-luna supports a larger window).
 * @type {number}
 */
