...
function registry() {
  if (!globalThis.__careerOpsDiscoverySchedules) {
    globalThis.__careerOpsDiscoverySchedules = new Map();
  }
  return globalThis.__careerOpsDiscoverySchedules;
}

function globalSlot() {
  if (!globalThis.__careerOpsGlobalDiscovery) {
    globalThis.__careerOpsGlobalDiscovery = { timer: null, run: null, intervalMs: DEFAULT_INTERVAL_MS, startedAt: null, lastTickAt: null };
  }
  return globalThis.__careerOpsGlobalDiscovery;
}
...
export function stopGlobalDiscoveryScheduler() {
  const slot = globalThis.__careerOpsGlobalDiscovery;
