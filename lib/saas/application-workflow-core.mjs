...
export function applyBrowserHeaded() {
  ...
  if (process.env.CAREER_OPS_SKIP_BROWSER === "1") return false;
  if (process.env.CAREER_OPS_HEADLESS === "1") return false;
  return process.env.CAREER_OPS_HEADED_BROWSER !== "0";
}
...
export async function launchApplyPage(url) {
  ...
  try {
    ...
    applyPage.__careerOpsHeaded = headed;
