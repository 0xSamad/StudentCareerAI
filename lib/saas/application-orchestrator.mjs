...
export class ApplicationOrchestrator {
    ...
    try {
      ...
      try {
        ...
        if (browser.ownedBrowser) {
          const headed = browser.applyPage?.__studentcareerHeaded === true || applyBrowserHeaded();
  ...
  async launchBrowser() {
    const shouldSkip = this.skipBrowser === true || process.env.STUDENT_CAREER_AI_SKIP_BROWSER === "1";
