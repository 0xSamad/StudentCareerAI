// lib/autonomous-pipeline.mjs — Autonomous Application Background Engine for StudentCareer AI
...
export class AutonomousPipeline {
  ...
  async processOpportunity({
    ...
    try {
      ...
      const skipBrowser =
        this.config.SKIP_BROWSER === true || process.env.STUDENT_CAREER_AI_SKIP_BROWSER === '1';
