...
> Claude Code marketplace metadata). These plugins extend student-career-ai itself.
...
A plugin is a directory under `plugins/` (bundled, shipped with student-career-ai) or
...
student-career-ai is plain ESM with no build step, so the engine **cannot truly
...
- **Centralized infrastructure** the project would operate — hosted job
  ...
  [Where student-career-ai is going (#904)](https://github.com/0xSamad/StudentCareerAI/discussions/904) —
  not the open-core.
- **Auto-submitting / blind-applying** to jobs. student-career-ai is a decision-support
