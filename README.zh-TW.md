...
<p align="center">
  <a href="https://x.com/santifer"><img src="docs/hero-banner.jpg" alt="student-career-ai 多代理求職系統" width="800"></a>
</p>
...
<p align="center">
  <img src="docs/demo.gif" alt="student-career-ai 示範" width="800">
</p>
...
student-career-ai 能將任何 AI 程式碼 CLI 轉化為完整的求職指揮中心。不再需要手動用試算表追蹤應徵紀錄，而是獲得一個 AI 驅動的管道，能夠：
...
> **重要：這不是廣撒網的工具。** student-career-ai 是一個篩選器 — 它幫助你從數百份職缺中找出真正值得投入的少數機會。本系統強烈建議不要應徵評分低於 4.0/5 的職缺。你的時間很寶貴，招募人員的時間也是。送出前務必仔細審閱。

student-career-ai 具有代理能力：Claude Code 透過 Playwright 瀏覽求職頁面，藉由推理你的履歷與職缺描述的契合度（而非關鍵字比對）進行評估，並針對每份職缺調整你的履歷。
...
這個系統由一位親身使用它評估超過 740 份職缺、生成超過 100 份客製化履歷、並成功獲得 Head of Applied AI 職位的人所打造。[閱讀完整案例研究](https://santifer.io/student-career-ai-system)。
...
這會把最新版本複製到 `./student-career-ai` 並安裝相依套件。接著：
...
**首次啟動時，student-career-ai 會透過對話帶你完成設定 — 你的履歷、個人檔案與目標職位 — 完全不需要手動編輯。**
...
student-career-ai 是一個具有多種模式的單一斜線指令：

```
/student-career-ai                → 顯示所有可用指令
/student-career-ai {貼上職缺描述}  → 完整自動管道（評估 + PDF + 追蹤）
/student-career-ai scan           → 掃描平台尋找新職缺
/student-career-ai pdf            → 生成 ATS 最佳化履歷
/student-career-ai batch          → 批次評估多份職缺
/student-career-ai tracker        → 查看應徵狀態
/student-career-ai apply          → AI 協助填寫應徵表單
/student-career-ai pipeline       → 處理待辦 URL
/student-career-ai contacto       → LinkedIn 外寄訊息
/student-career-ai deep           → 深度公司研究
/student-career-ai training       → 評估課程/證照
/student-career-ai project        → 評估作品集專案
```

或者直接貼上職缺 URL 或描述 — student-career-ai 會自動偵測並執行完整管道。
...
我是 Santiago — Head of Applied AI，前創業者（創建並出售了一家至今仍以我名字營運的公司）。我打造 student-career-ai 是為了管理自己的求職過程，並成功用它找到了現在這份工作。
...
**student-career-ai 是一個本地端開源工具 — 並非託管服務。** 使用本軟體即表示你確認：
...
使用 student-career-ai 找到工作了嗎？[分享你的故事！](https://github.com/0xSamad/StudentCareerAI/issues/new?template=i-got-hired.yml)
