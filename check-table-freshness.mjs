 ...
 *
 * Issue #2036 — github.com/0xSamad/StudentCareerAI
 */
...
const TEMPLATES_DIR = join(STUDENT_CAREER_AI, 'templates');
...
function loadConfigMaxAge() {
  const profilePath = join(STUDENT_CAREER_AI, 'config/profile.yml');
...
function printSummary(result, todayStr, maxAgeMonths) {
  ...
  console.log(`\n${'='.repeat(78)}`);
  console.log('  Table Freshness — student-career-ai');
