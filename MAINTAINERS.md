...
This file lists who maintains student-career-ai and how contributors grow into review and maintenance roles. It exists so the project doesn't depend on any single person and so the path forward is legible to everyone.
...
StudentCareer AI grows its team in the open. There are three rungs:

### 1. Contributor
Anyone who opens a PR or a helpful issue. No permissions needed — just contribute. Good first contributions: a new open-API scanner provider (`providers/`), a translation, a docs fix, or a [good first issue](https://github.com/0xSamad/StudentCareerAI/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22). See [CONTRIBUTING.md](CONTRIBUTING.md).
...
Because student-career-ai handles people's personal career data, access is granted carefully:
...
- Significant or breaking changes: an [RFC](https://github.com/0xSamad/StudentCareerAI/discussions/categories/rfc) first (see [CONTRIBUTING.md](CONTRIBUTING.md) → "Proposing big changes").
