...
// integration test via the STUDENT_CAREER_AI_TRACKER / STUDENT_CAREER_AI_ADDITIONS env
  ...
  try {
    ...
    try {
      output = execFileSync(NODE, [join(ROOT, 'merge-tracker.mjs')], {
        ...
        env: { ...process.env, STUDENT_CAREER_AI_TRACKER: tracker, STUDENT_CAREER_AI_ADDITIONS: addsDir },
      });
    } catch (e) {
