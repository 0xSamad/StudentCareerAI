...
const DEFAULT_PORTALS_PATH = process.env.STUDENT_CAREER_AI_PORTALS || 'portals.yml';
...
async function runSelfTest() {
  const tmp = mkdtempSync(join(tmpdir(), 'student-career-ai-validate-portals-self-test-'));
  try {
