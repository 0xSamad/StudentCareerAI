# StudentCareer AI on the Free Tier (Antigravity CLI)

student-career-ai works with **Antigravity CLI's free tier** — no API key or paid
...
3. Run student-career-ai as usual:
...
a rate-limit error; student-career-ai will pause and suggest retrying tomorrow.
