...
<p align="center">
  <a href="https://x.com/santifer"><img src="docs/hero-banner.jpg" alt="student-career-ai 멀티 에이전트 취업 시스템" width="800"></a>
</p>
...
<p align="center">
  <img src="docs/demo.gif" alt="student-career-ai 데모" width="800">
</p>
...
student-career-ai는 AI 코딩 CLI를 취업 활동 전체를 관리하는 커맨드 센터로 바꿔줍니다. 스프레드시트에서 수동으로 지원 현황을 관리하는 대신, AI 파이프라인이 알아서 처리합니다:
...
> **중요: 이 도구는 무차별 지원 도구가 아닙니다.** student-career-ai는 필터입니다 -- 수백 개의 공고 중 당신의 시간을 투자할 가치가 있는 소수의 공고를 찾아줍니다. 4.0/5 미만의 공고에는 지원하지 않는 것을 강력히 권장합니다. 당신의 시간도, 채용 담당자의 시간도 소중합니다. 제출 전에 항상 직접 검토하세요.

student-career-ai는 에이전트 기반으로 작동합니다: Claude Code가 Playwright로 채용 페이지를 탐색하고, 키워드 매칭이 아닌 이력서와 JD를 비교 분석하여 적합도를 판단하고, 공고별로 이력서를 맞춤 생성합니다.
...
740개 이상의 채용 공고를 평가하고, 100개 이상의 맞춤 이력서를 생성하여, Head of Applied AI 포지션에 합격한 사람이 직접 만들었습니다. [전체 케이스 스터디 읽기](https://santifer.io/student-career-ai-system).
...
이 명령어는 최신 릴리스를 `./student-career-ai`에 클론하고 의존성을 설치합니다. 그다음:
...
**처음 실행하면 student-career-ai가 대화만으로 설정 과정을 안내합니다 — 이력서, 프로필, 목표 직무까지. 손으로 편집할 것이 없습니다.**
...
student-career-ai는 다양한 모드를 가진 하나의 슬래시 커맨드입니다:

```
/student-career-ai                → 사용 가능한 모든 명령어 표시
/student-career-ai {JD 붙여넣기}  → 전체 자동 파이프라인 (평가 + PDF + 트래커)
/student-career-ai scan           → 포털에서 새 공고 스캔
/student-career-ai pdf            → ATS 최적화 이력서 생성
/student-career-ai batch          → 여러 공고 일괄 평가
/student-career-ai tracker        → 지원 현황 확인
/student-career-ai apply          → AI로 지원서 양식 작성
/student-career-ai pipeline       → 대기 중인 URL 처리
/student-career-ai contacto       → LinkedIn 아웃리치 메시지
/student-career-ai deep           → 기업 심층 리서치
/student-career-ai training       → 교육 및 자격증 가치 평가
/student-career-ai project        → 포트폴리오 프로젝트 평가
```

채용 공고 URL이나 설명을 바로 붙여넣어도 됩니다 -- student-career-ai가 자동으로 감지하여 전체 파이프라인을 실행합니다.
...
Santiago입니다 -- Head of Applied AI, 전직 창업자 (직접 사업을 만들고 매각했으며, 아직도 제 이름으로 운영되고 있습니다). 제 취업 활동을 관리하기 위해 student-career-ai를 만들었습니다. 효과가 있었습니다: 이 시스템으로 현재 포지션에 합격했습니다.
...
<a href="https://www.star-history.com/?repos=santifer%2Fstudent-career-ai&type=timeline&legend=top-left">
 <picture>
   ...
   <img alt="Star History 차트" src="https://api.star-history.com/chart?repos=0xSamad/StudentCareerAI&type=timeline&legend=top-left" />
 </picture>
</a>

## 면책 조항

**student-career-ai는 로컬 오픈소스 도구이며, 별도의 호스팅 서비스가 아닙니다.** 이 소프트웨어를 사용함으로써 다음 사항에 동의하는 것으로 간주됩니다:
