...
```json
{
  "name": "student-career-ai-plugin-<name>",
  "id": "<name>",
  "repo": "https://github.com/<you>/student-career-ai-plugin-<name>",
  "author": "<you>",
  "hooks": ["provider"],
...
- [ ] Naming `student-career-ai-plugin-<name>`; `id` == name minus the prefix
