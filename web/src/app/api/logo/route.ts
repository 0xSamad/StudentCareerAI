...
// Each key is fetched at most once ever, then served from .student-career-ai-web/logo-cache
...
function cacheDir(): string {
  return path.join(studentCareerRoot(), ".student-career-ai-web", "logo-cache");
}
