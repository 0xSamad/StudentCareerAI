  ...
  return (
    <>
      ...
      <header className="co-mnav flex items-center gap-2 border-b border-border px-4 pb-3 md:hidden">
        <Link href="/" className="flex min-h-[44px] items-center gap-2" aria-label="StudentCareer AI home">
          <CoMark size={26} />
          <span className={`${instrumentSerif.className} relative -top-px text-xl text-landing`}>StudentCareer AI</span>
        </Link>
