...
const STORAGE_KEY = "student-career-ai:config";
  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-10">
      ...
      <p className="mt-1 text-sm text-muted">
        Run StudentCareer AI on your own AI, right on your computer. Your CV and data never leave your machine.
      </p>
        ...
        {mode === "cli" && (
          <div>
            <p className="mb-1 text-sm text-muted">
              StudentCareer AI uses an AI tool you already have — signed in, your own usage, nothing to paste.
            </p>
            ...
            {clis === null ? (
              ...
              <div className="rounded-xl border border-dashed border-border bg-surface/30 p-4 text-sm text-muted">
                ...
                <a href="https://github.com/0xSamad/StudentCareerAI" target="_blank" rel="noreferrer" className="inline-flex items-center gap-0.5 text-brand hover:underline">
