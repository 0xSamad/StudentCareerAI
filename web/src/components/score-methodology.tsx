...
// Transparency = our differentiator ("why it's a 4.0 for YOU").
  ...
  return (
    <details className="group mt-10 overflow-hidden rounded-2xl border border-border bg-surface/30">
      <summary className="flex cursor-pointer list-none items-center gap-2 px-5 py-3.5 text-sm font-medium transition-colors hover:bg-surface-hover">
        How StudentCareer AI scored this — and why it&apos;s for <span className="text-landing">you</span>
      ...
      <div className="space-y-5 border-t border-border px-5 py-4 text-sm">
        <p className="text-muted">
          ...
          <strong className="text-brand">4.0</strong> is the apply / don&apos;t-apply line — below it, StudentCareer AI
        ...
        <a
          href="https://github.com/0xSamad/StudentCareerAI"
          target="_blank"
          rel="noreferrer"
