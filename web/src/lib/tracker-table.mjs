 ...
 * `tracker-aliases.json` in the student-career-ai root — the same single source
 ...
 * JSON file read with fs, like every other student-career-ai file this app consumes.
 *
 ...
 * @param {string} rootDir - student-career-ai root (studentcareerRoot() on the web side).
 ...
 * @param {string} rootDir - student-career-ai root holding tracker-aliases.json.
