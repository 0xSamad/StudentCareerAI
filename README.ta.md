...
## student-career-ai அறிமுகம்

student-career-ai ([student-career-ai.org](https://github.com/0xSamad/StudentCareerAI), **studentcareer** என்றும் அழைக்கப்படுகிறது) என்பது எந்த AI Coding CLI-யையும் வேலை தேடலுக்கான முழுமையான கட்டுப்பாட்டு மையமாக மாற்றும் ஒரு Open Source அமைப்பு. Spreadsheet-ல் விண்ணப்பங்களைக் கைமுறையாகக் கண்காணிப்பதற்குப் பதிலாக, AI-ஆல் இயக்கப்படும் ஒரு செயல்முறையை இது வழங்குகிறது. இதன் மூலம் நீங்கள்:
...
740-க்கும் மேற்பட்ட வேலை வாய்ப்புகளை மதிப்பீடு செய்து, 100-க்கும் மேற்பட்ட தனிப்பயனாக்கப்பட்ட CV-களை உருவாக்கி, **Head of Applied AI** பதவியைப் பெற்ற ஒருவரால் இந்த அமைப்பு உருவாக்கப்பட்டது. [முழுமையான அனுபவக் கட்டுரையை இங்கே படிக்கலாம்](https://santifer.io/student-career-ai-system).
...
இந்தக் கட்டளை, சமீபத்திய Release-ஐ `./student-career-ai` கோப்பகத்தில் Clone செய்து, தேவையான Dependencies-ஐ நிறுவும். அதன் பிறகு:
...
**முதல் முறையாக இயக்கும்போது, student-career-ai உங்களுடன் உரையாடி உங்கள் CV, Profile மற்றும் இலக்கு பணியிடங்களை (Target Roles) அமைக்க உதவும். கைமுறையாக எந்த கோப்பையும் திருத்த வேண்டியதில்லை.**
...
# உங்கள் CLI Slash Commands-ஐ ஆதரித்தால் /student-career-ai (அல்லது அதற்கான Alias)-ஐ பயன்படுத்தலாம்.
...
student-career-ai, Claude Code மற்றும் OpenCode போலவே, Antigravity CLI-யையும் இயல்பாக ஆதரிக்கிறது. அனைத்து Slash Commands-களும் ஒரே Shared Skill Entry Point வழியாக இயங்குகின்றன; அதே `modes/*.md` மதிப்பீட்டு செயல்முறையைப் பயன்படுத்துகின்றன.
...
```bash
# 1. Run in the student-career-ai directory
cd student-career-ai
agy

# 2. Use the unified /student-career-ai command with subcommands:
...
இந்த Skill, `.agents/skills/student-career-ai/SKILL.md`-ல் Open Standard-ஐப் பயன்படுத்தி வரையறுக்கப்பட்டுள்ளது. மேலும், ஆதரிக்கப்படும் ஒவ்வொரு CLI-க்கும் (எ.கா. `.claude/`, `.qwen/`, `.antigravitycli/`, `.grok/`) Symlink அல்லது Reference செய்யப்பட்டிருக்கிறது.

## Codex Integration

student-career-ai, அதே Shared Router மூலம் Codex-ஐ ஆதரிக்கிறது. ஆனால், Slash Commands-ஐ தானாகப் பதிவு செய்யும் CLI-களுடன் ஒப்பிடும்போது, இதன் Invocation முறை வேறுபடும். முழுமையான வழிகாட்டிக்கு `docs/CODEX.md`-ஐப் பார்க்கவும்.
...
Codex-இல் Slash Commands எப்போதும் கிடைக்கும் என்ற உத்தரவாதம் இல்லை. `/student-career-ai` கிடைக்காவிட்டால், தேவையான Mode-ஐ இயல்பான மொழியில் Codex-இடம் கேட்கலாம்.
...
student-career-ai, Claude Code மற்றும் OpenCode போலவே, Grok Build CLI-யையும் இயல்பாக ஆதரிக்கிறது. `AGENTS.md` Project விதிமுறைகளாக தானாகவே ஏற்றப்படுகிறது. மேலும், அனைத்து Slash Commands-களும் ஒரே Shared Skill Entry Point வழியாக செயல்படுகின்றன.
...
student-career-ai, அனைத்து CLI-களுக்கும் பொதுவான Command Router-ஐ பயன்படுத்துகிறது. Slash Commands-ஐ ஆதரிக்கும் CLI-களில் இது பின்வருமாறு செயல்படும்:

```text
/student-career-ai                → கிடைக்கக்கூடிய அனைத்து கட்டளைகளையும் காண்பி
/student-career-ai {paste a JD}   → முழு Auto-Pipeline (மதிப்பீடு + PDF + Tracker)
/student-career-ai scan           → புதிய வேலை வாய்ப்புகளை Scan செய்
/student-career-ai pdf            → ATS-optimized CV உருவாக்கு
/student-career-ai cover          → Cover Letter உருவாக்கு (JD அல்லது /student-career-ai cover {slug})
/student-career-ai email          → தொழில்முறை விண்ணப்ப Email வரைவு (வரைவு மட்டும்; அனுப்பாது)
/student-career-ai batch          → பல வேலை வாய்ப்புகளை ஒரே நேரத்தில் மதிப்பிடு
/student-career-ai tracker        → விண்ணப்பங்களின் தற்போதைய நிலையை காட்டு
/student-career-ai apply          → AI மூலம் விண்ணப்பப் படிவங்களை நிரப்பு
/student-career-ai pipeline       → நிலுவையில் உள்ள URL-களை செயலாக்கு
/student-career-ai contacto       → Hiring Manager / Recruiter / Team உறுப்பினரைக் கண்டறிந்து, LinkedIn செய்தி வரைவு உருவாக்கு
/student-career-ai deep           → நிறுவனம் குறித்த 6 அம்சங்களைக் கொண்ட ஆய்வை உருவாக்கு
/student-career-ai training       → ஒரு Course அல்லது Certification-ஐ மதிப்பிடு
/student-career-ai project        → ஒரு Portfolio Project-ஐ மதிப்பிடு
```

அல்லது, ஒரு Job URL அல்லது Job Description-ஐ நேரடியாக ஒட்டினாலே போதும். student-career-ai அதை தானாகக் கண்டறிந்து முழு Pipeline-ஐ இயக்கும்.
...
student-career-ai-ஐ என் சொந்த வேலை தேடலை எளிதாக்க உருவாக்கினேன். அது வெற்றிகரமாக செயல்பட்டு, நான் தற்போது இருக்கும் பணியைப் பெற உதவியது.

இந்த Repository-ஐ வாரத்திற்கு சுமார் **4 மணி நேரம்** மட்டுமே செலவழித்து எப்படி பராமரிக்கிறேன் என்பதை அறிய விரும்புகிறீர்களா?

[Agentic maintenance: how student-career-ai is run by a fleet of AI agents](https://santifer.io/ai-agent-fleet) என்ற கட்டுரையைப் படிக்கவும்.
...
**student-career-ai என்பது உங்கள் கணினியில் இயங்கும் Local Open Source கருவி மட்டுமே; இது Hosted Service அல்ல.** இந்த மென்பொருளைப் பயன்படுத்துவதன் மூலம், நீங்கள் பின்வருவனவற்றை ஏற்றுக்கொள்கிறீர்கள்:
...
<a href="https://github.com/0xSamad/StudentCareerAI/graphs/contributors">
  <img
  src="https://contrib.rocks/image?repo=0xSamad/StudentCareerAI"
  alt="student-career-ai contributors"
/>
</a>

student-career-ai-ஐ பயன்படுத்தி வேலை கிடைத்ததா? [உங்கள் வெற்றிக் கதையைப் பகிருங்கள்!](https://github.com/0xSamad/StudentCareerAI/issues/new?template=i-got-hired.yml)
...
**student-career-ai** என்ற பெயரும் அதன் Brand-மும் [Trademark Policy](TRADEMARK.md)-க்கு உட்பட்டவை. சமூகப் பயன்பாட்டிற்கு அனுமதி வழங்கப்பட்டாலும், வணிகப் பொருட்களின் பெயரிடல் மற்றும் அதிகாரப்பூர்வ ஒப்புதலுக்கான உரிமைகள் பாதுகாக்கப்பட்டுள்ளன.
