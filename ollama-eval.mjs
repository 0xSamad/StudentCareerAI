#!/usr/bin/env node
/**
 * ollama-eval.mjs — Ollama-powered Job Offer Evaluator for student-career-ai
 *
...
if (args.length === 0 || args[0] === '--help' || args[0] === '-h') {
  console.log(`
╔══════════════════════════════════════════════════════════════════╗
║           student-career-ai — Ollama Evaluator (local / free)          ║
╚══════════════════════════════════════════════════════════════════╝
...
// ---------------------------------------------------------------------------
console.log('\n' + '═'.repeat(66));
console.log('  STUDENT-CAREER-AI EVALUATION — powered by Ollama (' + modelName + ')');
