...
// Matches the STUDENT_CAREER_AI_PROFILE override already honored by scan.mjs,
...
const DEFAULT_PROFILE_PATH = process.env.STUDENT_CAREER_AI_PROFILE || 'config/profile.yml';
