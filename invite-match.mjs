#!/usr/bin/env node
/**
 * invite-match.mjs — Interview-Invite → Tracker Matcher for student-career-ai
 *
 ...
 *
 * Issue #1495 — github.com/0xSamad/StudentCareerAI
 */
...
function printSummary(result) {
  console.log(`\n${'='.repeat(70)}`);
  console.log('  Interview Invite Matcher — student-career-ai');
