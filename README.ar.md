...
<p align="right" dir="rtl">
  <a href="https://x.com/santifer"><img src="docs/hero-banner.jpg" alt="student-career-ai — نظام البحث عن وظائف القائم على عدة وكلاء ذكاء اصطناعي" width="800"></a>
</p>
...
<p align="center">
  <img src="docs/demo.gif" alt="عرض توضيحي لـ student-career-ai" width="800">
</p>
...
يقوم **student-career-ai** ([student-career-ai.org](https://github.com/0xSamad/StudentCareerAI)) بتحويل أي واجهة سطر أوامر للبرمجة بالذكاء الاصطناعي (AI coding CLI) إلى مركز قيادة كامل للبحث عن الوظائف. بدلًا من تتبع طلبات التوظيف يدويًا في جداول البيانات، تحصل على مسار عمل مدعوم بالذكاء الاصطناعي يقوم بـ:
...
تم تطوير هذا النظام بواسطة مهندس برمجيات وريادي أعمال استخدمه شخصيًا لتقييم أكثر من 740 عرض عمل، وتوليد أكثر من 100 سيرة ذاتية مخصصة، حتى حصل على منصب "رئيس قسم الذكاء الاصطناعي التطبيقي". [اقرأ دراسة الحالة الكاملة](https://santifer.io/student-career-ai-system).
...
يدعم student-career-ai بشكل أصلي واجهة [Gemini CLI](https://github.com/google-gemini/gemini-cli) بنفس الكفاءة والقواعد التي يدعم بها بيئات التوظيف الأخرى. جميع الأوامر الـ 15 متاحة وتستخدم نفس منطق التقييم تحت المجلد `modes/`.
...
/student-career-ai-evaluate --file ./jds/openai.txt
...
```text
/student-career-ai                ← لعرض كافة الأوامر المتاحة وتفاصيلها
/student-career-ai {رابط الوظيفة} ← تشغيل المسار التلقائي بالكامل (تقييم + PDF + تسجيل)
/student-career-ai scan           ← مسح بوابات التوظيف بحثًا عن فرص جديدة
/student-career-ai pdf            ← توليد سيرة ذاتية محسنة ومتوافقة مع ATS
/student-career-ai batch          ← تقييم مجموعة وظائف دفعة واحدة بالتوازي
/student-career-ai tracker        ← عرض وتحديث حالات التقديم الحالية
/student-career-ai apply          ← تعبئة نماذج التوظيف والردود بمساعدة الذكاء الاصطناعي
/student-career-ai pipeline       ← معالجة وفحص روابط الوظائف المنتظرة
/student-career-ai contacto       ← صياغة رسائل التواصل الموجهة عبر LinkedIn
/student-career-ai deep           ← إجراء بحث معمق واستخباراتي حول الشركة المستهدفة
/student-career-ai training       ← تقييم دورة تدريبية أو شهادة مهنية ومدى فائدتها لك
/student-career-ai project        ← تقييم مشروع شخصي في معرض أعمالك وكيفية عرضه
```
...
**ما هو student-career-ai؟**
student-career-ai هو مركز قيادة مفتوح المصدر للبحث عن الوظائف، وغير مرتبط بواجهة سطر أوامر بعينها. يحوّل أي واجهة سطر أوامر للبرمجة بالذكاء الاصطناعي إلى مسار عمل يقيّم العروض الوظيفية مقابل سيرتك الذاتية، وينشئ ملفات PDF مخصصة ومتوافقة مع أنظمة تتبع المتقدمين (ATS)، ويحدد الشخص المناسب للتواصل معه، ويتتبع كل شيء في مكان واحد — بينما يبقى القرار النهائي لك. وهو أول تطبيق مرجعي لـ StudentCareerAI Manifesto. المزيد على [student-career-ai.org](https://github.com/0xSamad/StudentCareerAI).

**هل يمكنني تشغيل student-career-ai مجانًا أو على نموذج أرخص أو محلي؟**
نعم. student-career-ai غير مرتبط بواجهة سطر أوامر بعينها ويعمل على النماذج المجانية والمحلية — عبر النماذج المجانية في OpenRouter، أو Ollama، أو أي نقطة نهاية متوافقة مع OpenAI — لذا فأنت لست مقيدًا باشتراك مدفوع. راجع [docs/RUNNING_ON_A_BUDGET.md](docs/RUNNING_ON_A_BUDGET.md) للإعداد الكامل.

**ما هي واجهات سطر الأوامر للذكاء الاصطناعي التي يعمل معها student-career-ai؟**
يعمل student-career-ai على أي واجهة سطر أوامر رئيسية للبرمجة بالذكاء الاصطناعي — Claude Code و Codex و Gemini / Antigravity و OpenCode و Grok و Qwen وغيرها — من خلال معيار Agent Skill Standard المفتوح، لذا فهو غير مقيد أبدًا بمزوّد واحد. استخدم الواجهة التي لديك بالفعل.

**كيف أثبّت student-career-ai على ويندوز؟**
student-career-ai يعمل على ويندوز. إذا فشل تحميل المهارات (skills) مع ظهور خطأ يتعلق بالروابط الرمزية (symlink) أثناء التثبيت، فالحل موجود في [docs/FAQ.md](docs/FAQ.md). الخطوات الكاملة في [docs/SETUP.md](docs/SETUP.md).

**هل يقوم student-career-ai بالتقديم على الوظائف تلقائيًا بالنيابة عني؟**
لا. student-career-ai أداة تصفية، وليست أداة تقديم تلقائي عشوائي. الذكاء الاصطناعي يقيّم ويرتّب ويكتب المسودات؛ وأنت تراجع وتقرر. لا يقوم أبدًا بإرسال أي طلب أو رسالة أو الضغط على أي زر — القرار النهائي لك دائمًا. وهذا التصميم الذي يُبقي الإنسان في الحلقة هو جوهر الفكرة.

**هل student-career-ai مجاني ومفتوح المصدر؟**
نعم. student-career-ai مجاني ومفتوح المصدر، وسيبقى كذلك دائمًا بالنسبة للمرشح — وهو أول تطبيق مرجعي لـ [StudentCareerAI Manifesto](https://github.com/0xSamad/StudentCareerAI/manifesto). اقرأه، وإن كان يعبّر عمّا تؤمن به، فوقّع عليه.

---

## إخلاء المسؤولية (Disclaimer)

**student-career-ai هي أداة محلية مفتوحة المصدر بالكامل — وليست خدمة مستضافة.** عند استخدامك لهذا البرنامج، فإنك تقر وتوافق على التالي:
...
<a href="https://github.com/0xSamad/StudentCareerAI/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=0xSamad/StudentCareerAI" alt="Contributors" />
</a>

هل نجحت في الحصول على وظيفة أحلامك باستخدام هذا النظام؟ [شارك قصتك معنا لتلهم الآخرين!](https://github.com/0xSamad/StudentCareerAI/issues/new?template=i-got-hired.yml)
