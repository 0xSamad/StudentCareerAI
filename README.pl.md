...
<p align="center">
  <a href="https://x.com/santifer"><img src="docs/hero-banner.jpg" alt="student-career-ai — Wieloagentowy system poszukiwania pracy" width="800"></a>
</p>
...
<p align="center">
  <a href="https://trendshift.io/repositories/25195" target="_blank"><img src="https://trendshift.io/api/badge/repositories/25195" alt="santifer%2Fstudent-career-ai | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
</p>
...
student-career-ai ([student-career-ai.org](https://github.com/0xSamad/StudentCareerAI), znany też jako **studentcareer**) zamienia dowolne AI CLI w pełne centrum dowodzenia poszukiwaniem pracy. Zamiast ręcznego śledzenia aplikacji w arkuszu kalkulacyjnym, dostajesz pipeline zasilany AI, który:
...
> **Ważne: to NIE jest narzędzie do masowego wysyłania aplikacji.** student-career-ai to filtr — pomaga znaleźć te kilka ofert wartych twojego czasu spośród setek. System stanowczo odradza aplikowanie na oferty z oceną poniżej 4.0/5. Twój czas jest cenny, podobnie jak czas rekrutera. Zawsze sprawdzaj przed wysłaniem.

student-career-ai działa agentowo: Claude Code nawiguje po stronach kariery z Playwright, ocenia dopasowanie rozumując nad twoim CV kontra opis stanowiska (nie przez dopasowanie słów kluczowych) i dostosowuje CV do każdego ogłoszenia.
...
Zbudowany przez kogoś, kto użył go do oceny 740+ ofert pracy, wygenerowania 100+ spersonalizowanych CV i zdobycia roli Head of Applied AI. [Przeczytaj pełne case study](https://santifer.io/student-career-ai-system).
...
To sklonuje najnowszą wersję do `./student-career-ai` i zainstaluje zależności. Następnie:
...
**Przy pierwszym uruchomieniu student-career-ai przeprowadza Cię przez konfigurację — CV, profil i docelowe stanowiska — wyłącznie przez rozmowę. Nic nie trzeba edytować ręcznie.**
...
student-career-ai to jedna komenda slash z wieloma trybami:

```text
/student-career-ai                    → Pokaż wszystkie dostępne komendy
/student-career-ai {wklej ofertę}     → Pełny auto-pipeline (ocena + PDF + tracker)
/student-career-ai scan               → Skanuj portale w poszukiwaniu nowych ofert
/student-career-ai pdf                → Generuj CV zoptymalizowane pod ATS
/student-career-ai batch              → Wsadowa ocena wielu ofert
/student-career-ai tracker            → Podgląd statusu aplikacji
/student-career-ai apply              → Wypełnianie formularzy aplikacyjnych z AI
/student-career-ai pipeline           → Przetwarzanie kolejki URL
/student-career-ai contacto           → Wiadomość na LinkedIn
/student-career-ai deep               → Szczegółowe badanie firmy
/student-career-ai training           → Ocena kursu/certyfikatu
/student-career-ai project            → Ocena projektu portfolio
```

Możesz też po prostu wkleić URL oferty lub jej treść — student-career-ai automatycznie to wykryje i uruchomi pełny pipeline.
...
student-career-ai obsługuje główne polskie portale IT. Dwa z nich — JustJoin.it i NoFluffJobs — mają publiczne API i mogą być zintegrowane jako źródła Level 0 (zero tokenów, brak WebSearch, świeże dane w czasie skanowania). Pozostałe portale wymagają weryfikacji ręcznej lub przez Playwright.
...
student-career-ai uwzględnia specyfikę polskiego rynku pracy przy ocenianiu ofert:
...
Jestem Santiago — Head of Applied AI, były founder (zbudowałem i sprzedałem firmę, która nadal działa z moim nazwiskiem). Zbudowałem student-career-ai do zarządzania własnym poszukiwaniem pracy. Zadziałało: użyłem go do zdobycia swojej obecnej roli.
...
**student-career-ai to lokalne narzędzie open source, NIE usługa hostingowa.** Korzystając z tego oprogramowania, potwierdzasz:
...
<a href="https://github.com/0xSamad/StudentCareerAI/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=0xSamad/StudentCareerAI" alt="Współtwórcy" />
</a>

Znalazłeś pracę dzięki student-career-ai? [Podziel się swoją historią!](https://github.com/0xSamad/StudentCareerAI/issues/new?template=i-got-hired.yml)

## Licencja i znak towarowy

Kod jest licencjonowany na [MIT](LICENSE). Nazwa i marka „student-career-ai" są regulowane przez [Politykę Znaków Towarowych](TRADEMARK.md) — dozwolone dla użytku społecznościowego, zastrzeżone dla komercyjnego nazewnictwa produktów i endorsementu.
