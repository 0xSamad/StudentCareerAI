# student-career-ai -- Mode Bahasa Indonesia (`modes/id/`)

Folder ini berisi terjemahan Bahasa Indonesia dari mode-mode utama student-career-ai untuk kandidat yang membidik pasar kerja Indonesia (startup tech, perusahaan, dan portal seperti Glints, Jobstreet, Kalibrr, LinkedIn ID).
