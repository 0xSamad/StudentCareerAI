# Konteks bersama -- student-career-ai (Bahasa Indonesia)

<!-- ============================================================
     PERSONALISASI FILE INI
     ============================================================
     File ini berisi konteks bersama untuk semua mode student-career-ai
     versi Bahasa Indonesia. Sebelum memakai student-career-ai, kamu HARUS:
