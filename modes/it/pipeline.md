...
Elabora gli URL degli annunci accumulati in `data/pipeline.md`. Il candidato aggiunge gli URL quando vuole, poi esegue `/student-career-ai pipeline` per elaborarli tutti in una volta.
