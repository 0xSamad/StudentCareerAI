...
5. **student-career-ai proof point**: Include in "Additional info" if there is a field for it
...
4. Suggest next step: run the `contacto` mode (`/student-career-ai contacto` where available) for LinkedIn outreach
