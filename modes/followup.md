...
(`/student-career-ai email noshow`) instead.
...
> "No active applications to follow up on. Apply to some roles first with `/student-career-ai` and come back when they're aging."
...
- Suggest the user run `/student-career-ai contacto {company}` to find the right person first
...
> - Trying a different contact via `/student-career-ai contacto`
...
**To:** {email or "No contact found — run `/student-career-ai contacto` first"}
