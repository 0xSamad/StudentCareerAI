...
If not:
> "No session transcripts found yet. Run `/student-career-ai interview` on a role after your next interview to generate a debrief, then come back to check for red flags."
