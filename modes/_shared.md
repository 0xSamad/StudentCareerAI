# System Context -- student-career-ai
...
<!-- ============================================================
     ...
     that improve with each student-career-ai release.
     ============================================================ -->
...
A mode may tell you to run work in a background subagent (e.g. `scan`, or parallel `pipeline` URLs) to spare the main agent's context. Any subagent you spawn for student-career-ai is a **single-pass worker**:
...
- One `/student-career-ai <JD>` evaluates one role; it must never explode into a self-replicating swarm of agents. If you are about to delegate research or nest agents, stop and do it inline, bounded.
