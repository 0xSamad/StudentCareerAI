# student-career-ai -- Tryby polskie (`modes/pl/`)

Ten folder zawiera polskie tłumaczenia głównych trybów student-career-ai dla kandydatów celujących w polski rynek pracy (Polska oraz polskojęzyczne zespoły).
