# student-career-ai -- Modos em Português BR (`modes/pt/`)

Esta pasta contém as traduções em português brasileiro dos principais modos do student-career-ai para candidatos que buscam vagas no mercado brasileiro ou em empresas que operam em português.
...
O student-career-ai não tem um "switch de idioma" como flag de código. Em vez disso, existem dois caminhos:
