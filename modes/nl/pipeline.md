...
Processen bieden URL's aan die zijn verzameld in `data/pipeline.md`. De kandidaat voegt URL's toe wanneer hij maar wil en voert vervolgens `/student-career-ai pipeline` uit om ze allemaal in één keer te verwerken.
