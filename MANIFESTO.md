...
We call this practice **StudentCareerAI**.
...
Volume was the old way. Automating the old way just makes noise faster. StudentCareerAI is the new way to search: evidence in, judgment out, fewer applications, on purpose.

## The name

StudentCareerAI, the name of the practice, belongs to everyone who practices it. student-career-ai, the project where it was born, remains its first reference implementation, nothing more. Build your own. Implementations welcome.
...
**Signed:**
Santiago Fernández de Valderrama Aparicio (santifer), creator of student-career-ai. July 14, 2026
