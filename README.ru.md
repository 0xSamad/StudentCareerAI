...
<p align="center">
  <a href="https://x.com/santifer"><img src="docs/hero-banner.jpg" alt="student-career-ai Мультиагентная система поиска работы" width="800"></a>
</p>
...
<p align="center">
  <img src="docs/demo.gif" alt="student-career-ai Демо" width="800">
</p>
...
student-career-ai превращает любой AI-CLI в полноценный командный центр для поиска работы. Вместо ручного ведения таблиц с откликами вы получаете ИИ-пайплайн, который:
...
Это клонирует последний релиз в `./student-career-ai` и устанавливает зависимости. Затем:
...
**При первом запуске student-career-ai проведёт тебя через настройку — твоё CV, профиль и целевые роли — просто через диалог. Ничего не нужно править вручную.**
...
student-career-ai — одна slash-команда с множеством режимов:

```
/student-career-ai                       → Показать все доступные команды
/student-career-ai {вставь описание JD}  → Полный авто-пайплайн (оценка + PDF + трекер)
/student-career-ai scan                  → Сканирование порталов
/student-career-ai pdf                   → Генерация ATS-резюме
/student-career-ai batch                 → Пакетная оценка вакансий
/student-career-ai tracker               → Статус откликов
/student-career-ai apply                 → Заполнение форм отклика с ИИ
/student-career-ai pipeline              → Обработка очереди URL
/student-career-ai contacto              → Сообщение в LinkedIn
/student-career-ai deep                  → Глубокий анализ компании
/student-career-ai training              → Оценка курса/сертификации
/student-career-ai project               → Оценка портфолио-проекта
```

Или просто вставь URL вакансии — student-career-ai автоматически определит его и запустит полный пайплайн.
...
student-career-ai поддерживает ключевые российские джоб-борды:
...
**Для чего нужен student-career-ai?**
student-career-ai — это приложение для поиска работы с открытым кодом, запускающийся через CLI. Данное приложение превращает CLI с встроенным AI-агентом в систему, которая будет оценивать, насколько вакансии соответствуют вашему резюме, генерировать файлы в формате PDF, адаптированные под каждый ATS, искать нужного человека для связи, и, конечно же, все будет отслеживаться в одном месте, оставляя окончательное решение за вами. Является первой реализацией StudentCareerAI Manifesto. Подробнее: [student-career-ai.org](https://github.com/0xSamad/StudentCareerAI).

**Можно ли использовать student-career-ai бесплатно или на более дешёвой/локальной модели?**
Да. student-career-ai не привязан к конкретному CLI и работает с бесплатными и локальными моделями — через OpenRouter, Ollama или любой другой OpenAI-совместимой точкой доступа — поэтому платная подписка необязательна. Ознакомиться с полной настройкой можно в [docs/RUNNING_ON_A_BUDGET.md](docs/RUNNING_ON_A_BUDGET.md)

**С каким AI CLI работает student-career-ai?**
student-career-ai работает с любым крупным AI CLI — Claude Code, Codex, Gemini / Antigravity, OpenCode, Grok, Qwen и другими — через открытый стандарт Agent Skill Standard, поэтому не привязан к одному поставщику. Используйте уже имеющийся CLI.

**Как установить student-career-ai на Windows?**
student-career-ai работает на Windows. Если навыки не загружаются из-за ошибки с символическими ссылками (symlink error) во время установки, ознакомьтесь с решением в [docs/FAQ.md](docs/FAQ.md). Полная инструкция в [docs/SETUP.md](docs/SETUP.md).

**student-career-ai отправляет заявки автоматически за меня?**
Нет. student-career-ai — это фильтр, а не автоматический рассыльщик. AI оценивает, ранжирует и создаёт черновики. Вы же проверяете их и принимаете решения. Он никогда не отправляет, не посылает и не нажимает ничего за вас — окончательный выбор всегда за вами. Принцип «человек в цикле» является ключевым.

**student-career-ai бесплатный? с открытым исходным кодом?**
Да. student-career-ai бесплатен и имеет открытый исходный код, и для соискателей всегда таким останется — это первая реализация [StudentCareerAI Manifesto](https://github.com/0xSamad/StudentCareerAI/manifesto). Прочтите, и если он отражает ваши убеждения, пожалуйста, подпишите его.

## Дисклеймер

**student-career-ai — локальный open-source инструмент, НЕ хостинг-сервис.** Используя это ПО, вы подтверждаете:
