...
student-career-ai ([student-career-ai.org](https://github.com/0xSamad/StudentCareerAI), जिसे **studentcareer** भी कहते हैं) किसी भी AI coding CLI को एक पूर्ण job search command center में बदल देता है। Applications को spreadsheet में manually track करने की जगह, आपको एक AI-powered pipeline मिलती है जो:
...
> **Important: यह spray-and-pray tool नहीं है।** student-career-ai एक filter है -- यह सैकड़ों offers में से उन कुछ offers को ढूंढने में मदद करता है जो आपके समय के लायक हैं। System strongly recommend करता है कि 4.0/5 से कम score वाले offers पर apply न करें। आपका समय मूल्यवान है, और recruiter का भी। Submit करने से पहले हमेशा review करें।

student-career-ai agentic है: जो भी AI coding CLI आप चुनें वह Playwright से career pages navigate करता है, आपके CV बनाम job description के बारे में reasoning करके fit evaluate करता है (keyword matching नहीं), और हर listing के लिए आपका resume adapt करता है।
...
किसी ऐसे व्यक्ति ने बनाया जिसने इसे 740+ job offers evaluate करने, 100+ tailored CVs generate करने, और Head of Applied AI role land करने के लिए use किया। [पूरा case study पढ़ें](https://santifer.io/student-career-ai-system)।
...
| **Cover Letter Generator** | Research-backed cover letters with keyword mirroring, four interactive angle prompts (why/problems/approach/tone), draft-in-chat approval gate, और A4 PDF। Auto-drafts हर evaluation पर; demand पर `/student-career-ai cover` से generate करें |
...
यह latest release को `./student-career-ai` में clone करता है और dependencies install करता है। फिर:
...
**पहले launch पर, student-career-ai setup के through walk करता है — आपका CV, profile और target roles — simply chatting करके। कुछ manually edit नहीं करना।**
...
# यदि CLI slash commands support करता है, /student-career-ai use करें (या CLI-specific alias)
# Codex में, same mode को plain language में ask करें, जैसे:
# "Run the student-career-ai scan mode"
...
Full setup guide के लिए [docs/SETUP.md](docs/SETUP.md) देखें, budget पर student-career-ai चलाने के लिए [docs/RUNNING_ON_A_BUDGET.md](docs/RUNNING_ON_A_BUDGET.md), और common setup questions के answers के लिए [docs/FAQ.md](docs/FAQ.md)।

## Antigravity CLI Integration

student-career-ai Antigravity CLI को natively support करता है, वैसे ही जैसे Claude Code और OpenCode को। सभी slash commands shared skill entrypoint के through available हैं, same `modes/*.md` evaluation logic use करके।
...
```bash
# 1. student-career-ai directory में run करें
cd student-career-ai
agy

# 2. Unified /student-career-ai command subcommands के साथ use करें:
...
Skill open standard में `.agents/skills/student-career-ai/SKILL.md` में defined है और हर supported CLI के लिए symlinked/referenced है (जैसे `.claude/`, `.qwen/`, `.antigravitycli/`, `.grok/`)।

## Codex Integration

student-career-ai Codex को same shared router के through support करता है, लेकिन invocation model CLIs से अलग है जो slash commands auto-register करते हैं। Full guide के लिए [docs/CODEX.md](docs/CODEX.md) देखें।
...
Slash commands Codex में guaranteed नहीं हैं। यदि `/student-career-ai` unavailable हो, Codex से mode को plain language में run करने को कहें:
...
student-career-ai Grok Build CLI को natively support करता है, वैसे ही जैसे Claude Code और OpenCode को। `AGENTS.md` project rules के रूप में auto-load होता है, और सभी slash commands shared skill entrypoint के through available हैं।
...
student-career-ai एक shared command router use करता है। CLIs में जो slash commands register करते हैं, यह इस तरह दिखता है:

```
/student-career-ai                → सभी available commands दिखाएं
/student-career-ai {JD paste करें}   → Full auto-pipeline (evaluate + PDF + tracker)
/student-career-ai scan           → नए offers के लिए portals scan करें
/student-career-ai pdf            → ATS-optimized CV generate करें
/student-career-ai cover          → Cover letter generator (JD paste करें या /student-career-ai cover {slug})
/student-career-ai batch          → Multiple offers batch evaluate करें
/student-career-ai tracker        → Application status देखें
/student-career-ai apply          → AI से application forms fill करें
/student-career-ai pipeline       → Pending URLs process करें
/student-career-ai contacto       → LinkedIn outreach message
/student-career-ai deep           → Deep company research
/student-career-ai training       → Course/cert evaluate करें
/student-career-ai project        → Portfolio project evaluate करें
```

या बस job URL या description directly paste करें -- student-career-ai auto-detect करेगा और full pipeline run करेगा।
...
**student-career-ai क्या है?**  
student-career-ai एक ओपन-सोर्स, CLI-agnostic जॉब सर्च कमांड सेंटर है। यह किसी भी AI कोडिंग CLI को ऐसे पाइपलाइन में बदल देता है जो आपके CV के अनुसार नौकरी के ऑफ़र्स का मूल्यांकन करता है, ATS-अनुकूल PDF तैयार करता है, सही व्यक्ति का संपर्क ढूँढता है, और पूरी प्रक्रिया को एक ही जगह ट्रैक करता है — जबकि अंतिम निर्णय हमेशा आपका होता है। यह StudentCareerAI Manifesto का पहला reference implementation है। अधिक जानकारी के लिए देखें: [student-career-ai.org](https://github.com/0xSamad/StudentCareerAI).

**क्या मैं student-career-ai को मुफ्त में या किसी सस्ते / लोकल मॉडल के साथ चला सकता हूँ?**  
हाँ। student-career-ai CLI-agnostic है और OpenRouter के मुफ्त मॉडल, Ollama, या किसी भी OpenAI-compatible endpoint के माध्यम से मुफ्त तथा लोकल मॉडलों पर चल सकता है। इसलिए आप किसी पेड सब्सक्रिप्शन पर निर्भर नहीं हैं। पूरी सेटअप प्रक्रिया के लिए [docs/RUNNING_ON_A_BUDGET.md](docs/RUNNING_ON_A_BUDGET.md) देखें।

## Author के बारे में

मैं [Santiago Fernández de Valderrama Aparicio](https://santifer.io/about) (santifer) हूँ -- Head of Applied AI, former founder (एक ऐसा business build किया और बेचा जो अभी भी मेरे नाम से चलता है)। मैंने student-career-ai अपनी खुद की job search manage करने के लिए बनाया। यह काम आया: मैंने इसे अपना current role land करने के लिए use किया।

क्या आप जानना चाहते हैं कि यह repo हफ्ते में सिर्फ ~4 घंटे में कैसे maintain होता है? पढ़ें [Agentic maintenance: how student-career-ai is run by a fleet of AI agents](https://santifer.io/ai-agent-fleet)।
...
**student-career-ai एक local, open-source tool है, hosted service नहीं।** यह software use करके आप acknowledge करते हैं:
...
student-career-ai use करके hired हुए? [अपनी story share करें!](https://github.com/0xSamad/StudentCareerAI/issues/new?template=i-got-hired.yml)

## License & Trademark

Code [MIT](LICENSE) के under licensed है। "student-career-ai" नाम और brand [Trademark Policy](TRADEMARK.md) के under governed हैं, community use के लिए permissive, commercial product naming और endorsement के लिए reserved।
