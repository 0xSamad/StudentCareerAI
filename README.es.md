...
<p align="center">
  <a href="https://x.com/santifer"><img src="docs/hero-banner.jpg" alt="student-career-ai Sistema Multi-Agente de Búsqueda de Empleo" width="800"></a>
</p>
...
<p align="center">
  ...
  &nbsp;
  <a href="https://www.npmjs.com/package/@0xSamad/StudentCareerAI"><img src="https://img.shields.io/npm/dt/@0xSamad/StudentCareerAI?style=for-the-badge&logo=npm&color=CB3837&label=npx%20installs" alt="npm installs"></a>
</p>
...
student-career-ai convierte cualquier CLI de IA en un centro de mando de búsqueda de empleo. En vez de trackear aplicaciones en un spreadsheet, tienes un pipeline AI que:
...
> **Importante: Esto NO es para spamear empresas.** student-career-ai es un filtro -- te ayuda a encontrar las pocas ofertas que merecen tu tiempo entre cientos. El sistema recomienda encarecidamente no aplicar a nada por debajo de 4.0/5. Tu tiempo es valioso, y el del recruiter también. Siempre revisa antes de enviar.
...
Construido por alguien que lo usó para evaluar 740+ ofertas, generar 100+ CVs personalizados, y conseguir un rol de Head of Applied AI. [Lee el case study completo](https://santifer.io/student-career-ai).
...
Esto clona la última release en `./student-career-ai` e instala las dependencias. Después:
...
**En el primer arranque, student-career-ai te guía en la configuración — tu CV, tu perfil y los roles que buscas — simplemente conversando. No hay nada qué editar a mano.**
...
```bash
npm i -g @0xSamad/StudentCareerAI
```

Esto instala el binario `student-career-ai` de forma global para que puedas ejecutarlo directamente en lugar de usar `npx`. A diferencia de `npx @0xSamad/StudentCareerAI init` (que prepara un directorio de proyecto), la instalación global te da un comando `student-career-ai` persistente disponible en cualquier terminal.

**¿Cuál deberías usar?**
- `npx @0xSamad/StudentCareerAI init` — mejor para el primer uso; crea una carpeta de proyecto dedicada.
- `npm i -g @0xSamad/StudentCareerAI` — mejor una vez que tienes una carpeta de proyecto y quieres ejecutar comandos de student-career-ai directamente.
...
student-career-ai es un único slash command con multiples modos:

```
/student-career-ai                → Mostrar todos los comandos
/student-career-ai {pega un JD}   → Pipeline completo (evaluar + PDF + tracker)
/student-career-ai scan           → Escanear portales
/student-career-ai pdf            → Generar CV ATS-optimizado
/student-career-ai batch          → Evaluar ofertas en batch
/student-career-ai tracker        → Ver estado de aplicaciones
/student-career-ai apply          → Rellenar formularios con IA
/student-career-ai pipeline       → Procesar URLs pendientes
/student-career-ai contacto       → Mensaje LinkedIn outreach
/student-career-ai deep           → Research profundo de empresa
```

O simplemente pega una URL o descripción de oferta -- student-career-ai la detecta y ejecuta el pipeline completo.
...
**¿Qué es student-career-ai?**
student-career-ai es un centro de mando de búsqueda de empleo, open source e independiente del CLI. Convierte cualquier CLI de IA en un pipeline que evalúa ofertas contra tu CV, genera PDFs optimizados para ATS, encuentra a la persona adecuada a la que escribir y lo registra todo en un solo sitio — y la decisión final siempre es tuya. Es la primera implementación de referencia del StudentCareerAI Manifesto. Más en [student-career-ai.org](https://github.com/0xSamad/StudentCareerAI).

**¿Puedo usar student-career-ai gratis, o con un modelo más barato o local?**
Sí. student-career-ai es independiente del CLI y funciona con modelos gratuitos y locales — mediante modelos gratuitos de OpenRouter, Ollama o cualquier endpoint compatible con OpenAI — así no dependes de ninguna suscripción de pago. Consulta [docs/RUNNING_ON_A_BUDGET.md](docs/RUNNING_ON_A_BUDGET.md) para la configuración completa.

**¿Con qué CLIs de IA funciona student-career-ai?**
student-career-ai funciona con cualquier CLI de IA importante — Claude Code, Codex, Gemini / Antigravity, OpenCode, Grok, Qwen y más — a través del estándar abierto Agent Skill Standard, así que nunca queda atado a un solo proveedor. Usa el CLI que ya tengas.

**¿Cómo instalo student-career-ai en Windows?**
student-career-ai funciona en Windows. Si las skills no cargan por un error de symlink durante la instalación, la solución está en [docs/FAQ.md](docs/FAQ.md). Los pasos completos están en [docs/SETUP.md](docs/SETUP.md).

**¿student-career-ai aplica a las ofertas por mí automáticamente?**
No. student-career-ai es un filtro, no un aplicador masivo a ciegas. La IA evalúa, ordena y redacta; tú revisas y decides. Nunca envía, manda ni hace clic en nada — la última palabra siempre es tuya. Ese diseño con supervisión humana es justo el punto.

**¿student-career-ai es gratis y open source?**
Sí. student-career-ai es gratis y open source, y para el candidato siempre lo será — es la primera implementación de referencia del [StudentCareerAI Manifesto](https://github.com/0xSamad/StudentCareerAI/manifesto). Léelo y, si dice lo que piensas, fírmalo.

## Sobre el autor

Soy [Santiago Fernández de Valderrama Aparicio](https://santifer.io/about) (santifer) -- Head of Applied AI, ex-fundador (monté y vendí un negocio que sigue funcionando con mi nombre). Construí student-career-ai para gestionar mi propia búsqueda de empleo. Funcionó: lo usé para conseguir mi puesto actual.

¿Curiosidad por cómo se mantiene este repo en ~4 horas a la semana? Lee [Agentic maintenance: how student-career-ai is run by a fleet of AI agents](https://santifer.io/ai-agent-fleet).
...
**student-career-ai es una herramienta local y open source — NO un servicio alojado.** Al usar este software, aceptas que:
